...
#ifndef DEBUG
        printf("starting\n");
        cube_t* cube = cubeNew(0, 0, 20, 6);
        ray_t* ray = rayNew(10, 5, 2);
        plane_t* plane = plane_new(cube->vertices[0], cube->vertices[1], cube->vertices[2]);
